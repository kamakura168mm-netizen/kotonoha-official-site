...
# koto_oshitalk_en01：#018書籍「海外ファンとも語り合える、推し活英語150フレーズ」。
# 司令塔43期夜勤追加発注（本人発案）で新規制作。本編は2026-09-02 21:38公開予約予定・
# 2026-08-28時点で未アップロード（アップ記録.json未記載）のため中継ページは先行構築のみ・
# チャンネルURLを暫定使用（koto_e01/koto_s02と同型）。公開後、実動画URLへ差し替えて再生成・push
# （司令塔の合図で実施。KDP提出自体は本人GO+司令塔GOが別途必要で、この中継ページ整備とは独立）。
KOTO_OSHITALK_EN01_VIDEO_URL = PROVISIONAL_VIDEO_URL  # 公開後に実URLへ差し替え
...
BOOKS = [
    ...
    },
    {
        ...
        # 2026-08-28・koto_t02_scenes.jsonのbook_chapter系キー付与に伴いFable起草版へ統一
        # （旧版=構想段階の章割りで現物scenes.jsonの区切りと不一致だったため置換）。
        "chapters": [
            (1, "気持ちよく伝わる褒め言葉"),
            (2, "外見コメントは短く、たまに"),
            (3, "服装はセーフ、体型はアウト"),
    ...
    {
        "source_id": "koto_oshitalk_en01",
        "book_title": "海外ファンとも語り合える、推し活英語150フレーズ #018",
        "channel": "ことのは英語",
        "video_url": KOTO_OSHITALK_EN01_VIDEO_URL,
        "chapters": [
            (1, "配信を見ての第一声"),
            (2, "尊さで動けなくなる瞬間"),
            (3, "SNS投稿とファンアカウント"),
